    ...
    if (script.readyState)
      script.onreadystatechange = function () {
        if (script.readyState == "loaded" || script.readyState == "complete") {
          ...
          load3DCarouselHtml5LightBox(jsFolder);
        }
      };
    else
...
function load3DCarouselHtml5LightBox(jsFolder) {
  (function ($) {
    $.fn.wp3dcarousellightbox = function (options) {
      ...
      inst.options = $.extend(
        {
          ...
          stamp: false,
          freemark:
            "87,111,114,100,80,114,101,115,115,32,51,68,32,67,97,114,111,117,115,101,108,32,84,114,105,97,108,32,86,101,114,115,105,111,110",
          watermark: "",
          watermarklink: "",
        },
        options,
      ...
      if (
        typeof wp3dcarousellightbox_options != "undefined" &&
        wp3dcarousellightbox_options
      )
        $.extend(inst.options, wp3dcarousellightbox_options);
      if ($("div.wp3dcarousellightbox_options").length)
        $.each(
          $("div.wp3dcarousellightbox_options").data(),
          function (key, value) {
      ...
      inst.disableKeyOutsideOfLightbox = function (event) {
        if (
          $(event.target).closest("#threedcarousel-html5-lightbox").length <= 0
        ) {
      ...
      inst.createMarkup = function () {
        ...
        styleCss +=
          ...
          "}";
        styleCss +=
          " #threedcarousel-html5-lightbox .html5-description {" +
          inst.options.descriptioncss +
          "}";
        styleCss +=
          " #threedcarousel-html5-lightbox .html5-error {" +
        ...
        if (inst.options.titlestyle == "right") {
          styleCss +=
            "#threedcarousel-html5-lightbox .html5-elem-wrap {width:" +
            inst.options.imagepercentage +
            "%;height:100%;} #threedcarousel-html5-lightbox .html5-elem-data-box {min-height:100%;}";
          styleCss +=
            "@media (max-width: " +
          ...
          styleCss +=
            "#threedcarousel-html5-lightbox .html5-elem-wrap {height:100%;} #threedcarousel-html5-lightbox .html5-elem-data-box {width:" +
        ...
        $("head").append(
          "<style type='text/css' data-creator='threedcarousel-html5-lightbox'>" +
            styleCss +
            "</style>",
        );
        var elemheight = inst.options.elemautoheight ? "auto" : "100%";
        inst.$lightbox = $(
          "<div id='threedcarousel-html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999998;text-align:center;'>" +
        ...
        if (inst.options.stamp)
          inst.$watermark.html(
            "<a href='" +
              ...
              "' style='text-decoration:none;' title='WordPress 3D Carousel'><div style='display:block;width:210px;height:20px;text-align:center;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:12px Arial,sans-serif;'><div style='line-height:20px;'>" +
      ...
      inst.showNavigation = function () {
        ...
        $("body").append(
          "<div id='threedcarousel-html5-lightbox-nav' class='html5-nav' style='display:block;position:" +
            posType +
            ";" +
            posCss +
            "width:100%;height:" +
      ...
      inst.finishDone = function () {
        ...
        $("head")
          .find("style")
          .each(function () {
            if ($(this).data("creator") == "threedcarousel-html5-lightbox")
              $(this).remove();
          });
      ...
      inst.embedHTML5Video = function (
        ...
        if (
          ...
          $("video", $container).wp3DLightboxHTML5VideoControls(
            inst.options.skinsfolder,
            inst,
      ...
      inst.each(function () {
        ...
        if (
          ...
          if ("autoopen" in wp3dcarousellightbox_options)
            autoopen = wp3dcarousellightbox_options.autoopen;
          if ("autoopendelay" in wp3dcarousellightbox_options)
            autoopendelay = wp3dcarousellightbox_options.autoopendelay;
          if ("autoopenonce" in wp3dcarousellightbox_options)
            autoopenonce = wp3dcarousellightbox_options.autoopenonce;
          if ("autoopenonceexpire" in wp3dcarousellightbox_options)
            autoopenonceexpire =
              wp3dcarousellightbox_options.autoopenonceexpire;
        }
      ...
      if ("wp3dcarousellightboxshare" in urlParams) {
        var shareUrl = decodeURIComponent(
          urlParams["wp3dcarousellightboxshare"],
        );
  ...
  (function ($) {
    $.fn.wp3DLightboxHTML5VideoControls = function (
      skinFolder,
      parentInst,
      videoElem,
      hideControls,
